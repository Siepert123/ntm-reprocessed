package com.nuclearnuisances.ntm.inventory;
    ...
    public static class ComparableStack extends AStack {
        ...
        public ComparableStack(ItemStack stack) {
            ...
            try {
                ...
                if(this.item == null) this.item = Items.AIR; //i'm going to bash some fuckard's head in
        ...
        public ItemStack toStack() {
            return new ItemStack(item == null ? Items.AIR : item, stacksize, meta);
        }
        ...
        public int hashCode() {
            ...
            if(item == null) {
               LOGGER.error("ComparableStack has a null item! This is a serious issue!");
            ...
            if(name == null) {
                LOGGER.error("ComparableStack holds an item that does not seem to be registered. How does that even happen? This error can be turned off with the config <enableSilentCompStackErrors>. Item name: " + item.getUnlocalizedName());
                Thread.currentThread().dumpStack();
                item = Items.AIR;
            }
            ...
            final int prime = 31;
            int result = 1;
            result = prime * result + item.getRegistryName().hashCode(); //using the int ID will cause fucky-wuckys if IDs are scrambled
